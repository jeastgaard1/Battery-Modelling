...
dL_total_anode   = zeros(options.init_height,options.init_width,options.L);       % Gesamtausdehnung der Anode [-]
dL_int_seg_anode = zeros(options.init_height,options.init_width,options.L);       % Ausdehnung durch Interkalation pro Segment [-]
...
dL_total_cathode   = zeros(options.init_height,options.seg_width,options.L);       % Gesamtausdehnung der Kathode [-]
dL_int_seg_cathode = zeros(options.init_height,options.seg_width,options.L);       % Ausdehnung durch Interkalation pro Segment [-]
...
dL_total = zeros(options.init_height,options.seg_width,options.L);
