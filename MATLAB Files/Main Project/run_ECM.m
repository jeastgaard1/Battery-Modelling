...
[options,msg]=options_ECM_VolThev;                      %Loads all settings: here you can set initial values, e.g. SoC

[param]=ECM_Parameter_ECM_VolThev(options);       %Loads cell parameter
